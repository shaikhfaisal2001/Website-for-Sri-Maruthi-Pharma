...
<html>
	...
	<div id="word2"><div id="wor1">to</div></div>
	<div id="word3"><div id="wor1">Sri Maruthi Pharma</div></div>
	...
	<img id="img1" src="img/background.jpg" alt="Image">
	...
	<div><img id="contentimage" src="img/banner.jpg"></div>
	...
	<footer>
        <div class="footer-logo">
            <img id="img2logo" src="img/img5.png" alt="Sri Maruthi Pharma logo">
			<h3>Sri Maruthi Pharma.</h3>
        </div>
		<br>
		<br>
        ...
        <div class="footer-info">
            <div class="info-container">
                ...
                <ul>
                    <li><a href="aboutus/aboutus.php">About Sri Maruthi Pharma</a></li>
            ...
            <div class="info-container">
                ...
                <ul class="social">
                    <li><a class="fbicon" href="https://facebook.com/" title="Facebook" target="_blank"><i class="fa fa-facebook-square"></i> <span id="fb">Facebook/Sri Maruthi Pharma</span></a></li>
                    <li><a class="twittericon" href="https://twitter.com/" title="twitter" target="_blank"><i class="fa fa-twitter-square"></i> <span id="tw">Twitter/Sri Maruthi Pharma</span></a></li>
                    <li><a class="googleicon" href="https://plus.google.com/" title="google+" target="_blank"><i class="fa fa-google-plus-square"></i> <span id="go">Google+/Sri Maruthi Pharma</span></a></li>
                 <!--  <li><a class="pinteresticon" href="https://www.pinterest.com/" title="Pinterest" target="_blank"><i class="fa fa-pinterest-square"></i>pinterest/Medicare</a></li>-->
                    <li><a class="linkedinicon" href="https://www.linkedin.com/" title="LinkedIn" target="_blank"><i class="fa fa-linkedin-square"></i><span id="li"> Linkedin/Sri Maruthi Pharma</span></a></li>
                </ul>

        </div>
		</div>
        <div class="footer-copyright">
            <p> Copyright© 2022 Sri Maruthi Pharma. All Rights Reserved</p>
        </div>
    </footer>
